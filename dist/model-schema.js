...
var _mongoosePluginCreatedat = require('mongoose-plugin-createdat');

var _mongoosePluginCreatedat2 = _interopRequireDefault(_mongoosePluginCreatedat);

var _mongoosePluginUpdatedat = require('mongoose-plugin-updatedat');

var _mongoosePluginUpdatedat2 = _interopRequireDefault(_mongoosePluginUpdatedat);
  ...
  (0, _createClass3.default)(Schema, [{
    ...
    value: function _enablePlugins() {
      if (this.getOption('autoIncrement') != false) {
        _mongooseAutoIncrement2.default.initialize(this.getConnection());
        this.plugin(_mongooseAutoIncrement2.default.plugin, {
      ...
      if (this.getOption('createdAt')) this.plugin(_mongoosePluginCreatedat2.default);
      if (this.getOption('updatedAt')) this.plugin(_mongoosePluginUpdatedat2.default);

      if (this.getOption('paginate')) this.plugin(_mongoosePaginate2.default);
