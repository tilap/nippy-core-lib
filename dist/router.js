      ...
      folders.forEach(function (src) {
        ...
        _fs2.default.readdirSync(src).forEach(function (file) {
          ...
          if (_fs2.default.statSync(fullPath).isFile()) {
            var newObject = require(fullPath); // eslint-disable-line global-require
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        Controller = require(router.controllerPath + '/' + dispatch.controller); // eslint-disable-line global-require
