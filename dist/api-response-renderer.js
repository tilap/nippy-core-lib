...
function toHtml(apiResponse) {
  var showStackTraceOnError = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];

  var result = toJson(apiResponse, showStackTraceOnError);
  ...
  content += (0, _jsonBeautify2.default)(result, null, 2, 80);
  content += '</pre></div>';
