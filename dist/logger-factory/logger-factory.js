...
var _loggerFactoryConfig = require('./logger-factory-config');

var _loggerFactoryConfig2 = _interopRequireDefault(_loggerFactoryConfig);
...
module.exports = function () {
  function LoggerFactory() {
    ...
    this.config = new _loggerFactoryConfig2.default();
  ...
  (0, _createClass3.default)(LoggerFactory, [{
      ...
      switch (type) {
        ...
        default:
          if (type.constructor === String) {
            try {
              return require(type); // eslint-disable-line global-require
            } catch (err) {
            ...
            var _ret = function () {
              ...
              if (!options.hasOwnProperty('formatter')) {
                options.formatter = function (opts) {
                  ...
                  return _cliColor2.default[color](res.join(' '));
                };
              }
              return 'break';
            }();
    ...
    value: function get(id) {
      ...
      return new _winston2.default.Logger({ transports: transports });
    }
  }]);
